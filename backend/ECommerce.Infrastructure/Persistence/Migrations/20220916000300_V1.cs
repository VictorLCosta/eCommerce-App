        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortName = table.Column<string>(type: "varchar(150)", nullable: true),
                    DeliveryTime = table.Column<string>(type: "varchar(150)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    State = table.Column<string>(type: "varchar(150)", nullable: true),
                    Zipcode = table.Column<string>(type: "varchar(150)", nullable: true),
                    AppUserId = table.Column<string>(type: "varchar(150)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", nullable: true),
                    PictureUrl = table.Column<string>(type: "varchar(150)", nullable: true),
                    DefaultPrice_Currency = table.Column<string>(type: "TEXT", nullable: true),
                    DefaultPrice_Amount = table.Column<decimal>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_ProductBranches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryDate = table.Column<long>(type: "INTEGER", nullable: false),
                    ...
                    Subtotal_Currency = table.Column<string>(type: "TEXT", nullable: true),
                    Subtotal_Amount = table.Column<decimal>(type: "TEXT", nullable: true),
