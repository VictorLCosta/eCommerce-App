...
import type { ProductBriefDto } from "../../../../models/product";
...
const ProductListCard = ({ product }: Props) => (
	<div className="product-card">
		...
		{product.localSeller && <ShowcaseBadge content="local" angle />}
		...
		<div className="card-content">
			...
			<div className="name">
				<Link to={`/products/${product.id}`}>{product.name.substring(0, 30) + "..."}</Link>
			</div>
