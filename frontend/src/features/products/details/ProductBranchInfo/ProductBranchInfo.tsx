...
const ProductBranchInfo = ({ branchId }: Props) => {
	const {
		branchStore: { currentBranch, loading, clearCurrentBranch, loadBranch },
	} = useStore();
			...
			{loading ? (
				...
				<Grid divided>
						...
						<div className="branch-info">
							...
							<div className="branch-main-info">
								...
								<div className="actions">
									<Button color="orange" content="Chat now" size="big" icon="talk" basic />
									<Button content="View store page" size="big" icon="home" basic />
								</div>
							</div>
						</div>
					</Grid.Column>
					...
					<Grid.Column computer={10}>
						<div className="branch-statistics">flembas</div>
					</Grid.Column>
				</Grid>
			)}
		</Segment>
