...
const DesktopMenu = () => {
    const { commonStore: { isDesktopMenuVisible, toggleDesktopMenuVisibility } } = useStore();
                    ...
                    <List sx={{ width: '100%' }}>
                        <ListItem disablePadding divider>
                            <Link to={'/'} className="home-link">
                                <ListItemText primary="Home" primaryTypographyProps={{fontSize: '1.6rem', fontWeight: 600}} />
                            </Link>
                        </ListItem>

                        <DesktopListItem text="Men's" fontSize='1.6rem' fontWeight={600} padding=".5rem 0" divider />

                        <DesktopListItem text="Women's" fontSize='1.6rem' fontWeight={600} padding=".5rem 0" divider />

                        <DesktopListItem text="Blog" fontSize='1.6rem' fontWeight={600} padding=".5rem 0" divider />
                    </List>

                    <List>

                        <CollapsibleListItem itemText='Language' fontSize='1.6rem'>
                            <DesktopListItem text="Português - BR" fontSize='1.3rem' fontWeight={500} padding="0 1rem" />
